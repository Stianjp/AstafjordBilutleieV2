export const translations = {
  no: {
    ...
    hero: {
      title: "Bilutleie i Astafjord",
      subtitle: "Book bilen din. Vi bekrefter manuelt innen kort tid.",
  ...
  en: {
    ...
    hero: {
      title: "Astafjord car rental",
      subtitle: "Request a booking. We confirm manually shortly.",
